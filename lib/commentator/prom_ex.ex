defmodule Commentator.PromEx do
  @moduledoc """
  ...
  1. Update your configuration (config.exs, dev.exs, prod.exs, releases.exs, etc) to
     ...
     ```
     config :commentator, Commentator.PromEx,
       disabled: false,
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule CommentatorWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :commentator
  ...
  use PromEx, otp_app: :commentator
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam
      # {Plugins.Phoenix, router: CommentatorWeb.Router, endpoint: CommentatorWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
      ...
      # Commentator.Users.PromExPlugin
    ]
  end
  ...
  def dashboard_assigns do
    [
      datasource_id: "grafanacloud-resonant-prom",
  ...
  def dashboards do
    [
      ...
      # {:commentator, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
